                ...
                <div className="col-form">
                  ...
                  <fieldset style={{ border:'1px solid var(--border)', borderRadius:16, padding:'16px 18px', background:'var(--surface)', marginTop:12 }}>
                    ...
                    <div className="row" style={{ display:'flex', gap:14, flexWrap:'wrap' }}>
                      ...
                      <label className="field grow">Extra rclone flags <input value={cfg.options.extraFlags} onChange={e=>{ setCfg(c=>({...c,options:{...c.options,extraFlags:e.target.value}})); markDirty(); }} placeholder="--transfers 8 --checkers=32 --fast-list --progress --log-level=INFO --retries 5 --low-level-retries 20 --retries-sleep 10s" /></label>
                    </div>
                  </fieldset>
